    ...
    <section id={id} className="min-h-screen flex items-center justify-center p-6">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between">
        <div className="md:w-1/2 mb-10 md:mb-0">
          ...
          <p>
            <span className="text-blue-500">Native iOS Developer</span> <br />
        ...
        <div className="md:w-2/5">
          <div className="relative">
            <div className="w-full h-96 bg-gradient-to-br from-blue-400 to-purple-500 rounded-3xl shadow-xl flex items-center justify-center">
